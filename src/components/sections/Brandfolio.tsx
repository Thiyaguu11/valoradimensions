        ...
        <section id="brandfolio" className="py-32 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                >
                    ...
                    <p className="mt-4 text-violet-200/60 max-w-2xl mx-auto">
                ...
                <div className="flex overflow-x-auto pb-8 gap-8 scrollbar-hide snap-x snap-mandatory no-scrollbar" style={{ msOverflowStyle: 'none', scrollbarWidth: 'none' }}>
                    {projects.map((project, index) => (
                        <motion.div
                            ...
                            className="min-w-[300px] md:min-w-[400px] bg-white/5 backdrop-blur-3xl border border-white/10 rounded-3xl overflow-hidden snap-center group hover:border-violet-500/30 transition-all duration-500"
                        >
                            {/* Image Placeholder */}
                            ...
                            <div className="p-8">
                                <div className="flex items-center gap-3 mb-4">
                                    <span className="px-3 py-1 rounded-full bg-violet-600/20 text-violet-300 text-xs font-medium border border-violet-500/20">
                                        {project.category}
                                    </span>
                                    <span className="text-violet-200/40 text-xs">Mar 16, 2024</span>
                                </div>
                                ...
                                <p className="text-violet-200/60 text-sm leading-relaxed mb-8">
                                    Comprehensive digital transformation and strategic brand positioning for market leadership.
                                </p>

                                <div className="flex items-center gap-4 pt-6 border-t border-white/5">
                                    <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-violet-500 to-indigo-500 border border-white/10" />
                                    <div>
                                        <div className="text-white font-medium text-sm">Alex Rivera</div>
                                        <div className="text-violet-200/40 text-xs">Creative Director</div>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 mt-12 flex justify-center">
                <button className="text-white bg-white/5 border border-white/10 px-8 py-3 rounded-full hover:bg-white/10 hover:border-violet-500/30 transition-all flex items-center gap-2 group">
